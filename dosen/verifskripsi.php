            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table dataTable" id="datatablesSimple1">
                        ...
                        <tbody>
                        <?php
                                $query = "SELECT mahasiswa.NIM,mahasiswa.Nama FROM mahasiswa,skripsi WHERE mahasiswa.NIM = skripsi.NIM AND skripsi.status_verif ='Belum'";
                                ...
                                while ($row = $result->fetch_object()) {
                                    ...
                                    <td>".$row->NIM."</td>
                                    <td>".$row->Nama."</td>
                                    <td><a class='btn btn-primary' href='lihatkripsi.php'>Lihat</a></td>";
                                    $i++;                        
                                }
                            ?>
                        </tbody>
