            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table dataTable" id="datatablesSimple1">
                        ...
                        <tbody>
                        <?php
                                $query = "SELECT mahasiswa.NIM,mahasiswa.Nama FROM mahasiswa,khs WHERE mahasiswa.NIM = khs.NIM AND khs.status='Belum'";
                                ...
                                while ($row = $result->fetch_object()) {
                                    ...
                                    <td>".$row->NIM."</td>
                                    <td>".$row->Nama."</td>
                                    <td><a class='btn btn-primary' href='lihatkhs.php'>Lihat</a></td>";
                                    $i++;                        
                                }
                            ?>
                        </tbody>
