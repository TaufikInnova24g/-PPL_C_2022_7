...
$query ="SELECT * FROM rekap_skripsi ORDER BY nama DESC";  
...
<div>
        ...
        <h2>Data Rekap  Skripsi Mahasiswa Informatika</h2>
        </div>
           ...
           <br /><br />  
           <div class="container"> 
           <p><a type="button" class="btn btn-success button-add" href="add_skripsi.php">(+) Tambah Data</a></p>   
                     ...
                     <table id="employee_data" class="table table-striped table-bordered">  
                          ...
                          {  ?>
                            <tr>
                              ...
                              <td>
                                <a type="button" class="btn btn-warning button-edit" href="edit_skripsi.php?idedit=<?php echo $row['id_mahasiswa']?>">Edit</a> 
                                <a type="button" class="btn btn-danger button-delete" href="delete_skripsi.php?iddel=<?php echo $row['id_mahasiswa']?>" onclick="return confirm('Apakah data yang ingin di hapus sudah benar?')">Delete</a>
                              </td>
                          </tr> 
                        <?php } ?>  
                     </table>  
