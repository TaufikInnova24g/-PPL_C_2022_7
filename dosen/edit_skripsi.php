...
if (!isset($_POST["submit"])){
    //execute the query
    $result = $db->query(" SELECT * FROM rekap_skripsi WHERE id_mahasiswa=" .$id. " ");
    if (!$result){
    ...
    if (isset($_POST["submit"])){
        ...
        if ($valid){
            //escape inputs data
            //asign a query
            $query = " UPDATE rekap_skripsi SET nama='".$nama."', nim='".$nim."', sks='".$sks."' , ipk='".$ipk."',status_kelulusan='".$status_kelulusan."' , angkatan='".$angkatan."' WHERE id_mahasiswa=".$id." ";
            //execute the query
            ...
            if (!$result){
                ...
                $db->close();
              echo "<script>alert('Data berhasil diupdate');window.location='rekapSkripsi.php';</script>";
            }
        }
    }
}
...
<html lang="en">
    ...
    <section class="content-header">
        <div class="container mt-3">
            <div class="card ">
        <div class="card-header">Edit Data Skripsi</div>
                <div class="card-body">
