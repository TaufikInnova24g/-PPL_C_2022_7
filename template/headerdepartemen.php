...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
            <a class="navbar-brand ps-3" href="dashboardDepartemen.php">
              <img src="https://kulon2.undip.ac.id/pluginfile.php/1/theme_moove/favicon/1660361299/undip.ico" alt="logo undip" width = 40 height = 40> <b class="">Dashboard Departemen</b>
            </a>
    </nav>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                         <div class="user-panel">
                            ...
                            <li>
                                <a href="dashboardDepartemen.php" style="text-decoration:none; color: black;">
